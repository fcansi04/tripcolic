...
const Nav = ({ filteredCards, setfilteredCards }) => {
  ...
  return (
    <nav className="flex justify-between mt-4 px-10 max-md:px-4 ">
      ...
      <div
        className={`mt-4 p-4 absolute top-10 border-2 rounded-3xl md:h-[50rem] max-md:[55rem]  flex flex-col  w-[95%]  ${
          popped ? "" : "hidden"
        }`}
      >
